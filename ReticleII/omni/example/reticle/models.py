...
class ReticleModel:
    ...
    def __init__(self):
        ...
        self.circlet_action_safe_enabled = ui.SimpleBoolModel(False)
        
        self.circlet_action_safe_percentage = ui.SimpleFloatModel(constants.DEFAULT_CIRCLET_ACTION_SAFE_PERCENTAGE, min=0, max=100)
        self.circlet_title_safe_enabled = ui.SimpleBoolModel(False)
        self.circlet_title_safe_percentage = ui.SimpleFloatModel(constants.DEFAULT_CIRCLET_TITLE_SAFE_PERCENTAGE, min=0, max=100)
        self.circlet_custom_safe_enabled = ui.SimpleBoolModel(False)
        self.circlet_custom_safe_percentage = ui.SimpleFloatModel(constants.DEFAULT_CIRCLET_CUSTOM_SAFE_PERCENTAGE, min=0, max=100)
    ...
    def _register_submodel_callbacks(self):
        ...
        self.circlet_action_safe_enabled.add_value_changed_fn(self._reticle_changed)
        self.circlet_action_safe_percentage.add_value_changed_fn(self._reticle_changed)
        self.circlet_title_safe_enabled.add_value_changed_fn(self._reticle_changed)
        self.circlet_title_safe_percentage.add_value_changed_fn(self._reticle_changed)
        self.circlet_custom_safe_enabled.add_value_changed_fn(self._reticle_changed)
        self.circlet_custom_safe_percentage.add_value_changed_fn(self._reticle_changed)
