...
cl.circlet_action_safe_default = cl(0.0, 1.0, 1.0)
cl.circlet_title_safe_default  = cl(0.0, 0.0, 1.0)
cl.circlet_custom_safe_default = cl(1.0, 0.0, 1.0)
...
safe_areas_group_style = {
    ...
    "Rectangle::CircleActionSwatch": {
        "background_color": cl.circlet_action_safe_default
    },
    "Rectangle::CircleTitleSwatch": {
        "background_color": cl.circlet_title_safe_default
    },
    "Rectangle::CircleCustomSwatch": {
        "background_color": cl.circlet_custom_safe_default
    }
}
comp_group_style = {
    "Button.Image::Off": {
    ...
    "Button.Image::Crosshair": {
     ...
     "Button.Image::BigX": {
        "image_url": str(ICON_PATH / "BIGX.png")
    },
     "Button.Image::BigCirclet": {
        "image_url": str(ICON_PATH / "BigCirclet.png")
    },
    "Button:checked": {
